...
MainSection:NewButton("Unlock Attic", "Unlocks The Attic", function()
...
game:GetService("ReplicatedStorage").RemoteEvents.Ladder:FireServer(unpack(args))
        wait(0.5)
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-20.3797321, 19.4470501, -226.114609, 0.999289334, -4.8147065e-08, 0.0376946107, 4.87700156e-08, 1, -1.56067319e-08, -0.0376946107, 1.7434008e-08, 0.999289334)
end)
